...
const IcPencil = ({ filled, size, color }) =>
{
    if(filled === true)
    {
        return (
    ...
    return (
        <Svg
            ...
            strokeWidth="32"
        >
            <Path d="M364.13 125.25L87 403l-23 45 44.99-23 277.76-277.13-22.62-22.62zM420.69 68.69l-22.62 22.62 22.62 22.63 22.62-22.63a16 16 0 000-22.62h0a16 16 0 00-22.62 0z"/>
        </Svg>
    )
}
